...
export const INSTRUCTIONS = [
  ...
  "  KAPI KOYDUKTAN SONRA auto_gates ÇAĞIR. Kapı ekleyip bloklara",
  "  bağlamamak planı DAHA KÖTÜ yapar: kapısızken yalnız bir uyarı vardı,",
  "  bağlanmamış kapı 'blok hiçbir kapıya bağlı değil' HATASI üretir.",
  "  On örnek mekânın onunda da her blok bir kapıya bağlı — 2 kapılı",
  "  Süreyya'da da, 96 kapılı Galatasaray'da da.",
